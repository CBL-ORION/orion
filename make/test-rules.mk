...
$(BUILDTESTDIR)/integration/itk/itk: CPPFLAGS += $(ITK_CPPFLAGS)
$(BUILDTESTDIR)/integration/itk/itk: LDFLAGS  += $(ITK_LDFLAGS)
$(BUILDTESTDIR)/integration/itk/itk: LDLIBS   += $(ITK_LDLIBS)
